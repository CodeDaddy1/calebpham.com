...
// A quoted excerpt from a real repository: the file, the line range, and a
// link that pins the exact commit, or the words "private repository" when
// there is none. The fenced block inside it is rendered by mdx-components'
